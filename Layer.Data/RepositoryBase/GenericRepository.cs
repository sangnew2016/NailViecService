...
namespace Layer.Data.RepositoryBase
{
    ...
    {
        private readonly NailViecContextProvider _contextProvider;

        public GenericRepository(NailViecContextProvider contextProvider)
        {
        ...
        internal NailViecAppContext Context
        {
